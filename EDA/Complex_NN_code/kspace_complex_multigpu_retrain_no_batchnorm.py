...
def ensure_complex(x):
    ...
    raise ValueError(f"Expected complex tensor or (..., 2), got shape={tuple(x.shape)}, dtype={x.dtype}")
...
def main():
    ...
    # Setup paths for model and metrics
    saved_model_path = "/home/biswamitra/health/knee_data/EDA/saved_model/complex_kspace_model_ret_DP.pth"
    ...
    # <-- NEW: Initialize the dictionary to hold history
    history = {
        "train_loss": [],
        "val_loss": [],
        "train_psnr": [],
    ...
    try:
        for epoch in range(num_epochs):
            ...
            if rank == 0:
                ...
                # <-- NEW: Save the updated history to JSON file
