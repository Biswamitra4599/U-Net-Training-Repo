...
def main():
    ...
    saved_model_path = "/home/biswamitra/health/knee_data/EDA/saved_model/complex_kspace_model_ret_DDP.pth"
    saved_model_dir = os.path.dirname(saved_model_path)
    metrics_path = os.path.join(saved_model_dir, "training_metrics_ret_DDP.json") 
